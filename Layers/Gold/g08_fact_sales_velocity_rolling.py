...
# MAGIC %md
# MAGIC # Build Sales Velocity & Forecast
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `fact_sales_velocity`  
# MAGIC **Description**: 7/30-day avg, stockout prediction  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("fact_sales_velocity")

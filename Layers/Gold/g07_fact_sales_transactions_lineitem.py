...
# MAGIC %md
# MAGIC # Build Fact Sales Transactions
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `fact_sales_transactions`  
# MAGIC **Description**: Line-item grain, margin, channel  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("fact_sales_transactions")

...
# MAGIC %md
# MAGIC # Build Price History (SCD Type 2)
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `dim_product_price_history`  
# MAGIC **Description**: List price, cost, promotions  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("dim_product_price_history")

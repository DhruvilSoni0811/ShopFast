...
# MAGIC %md
# MAGIC # Build Daily Inventory Summary
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `agg_daily_inventory_summary`  
# MAGIC **Description**: Pre-aggregated for dashboards  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("agg_daily_inventory_summary")

...
# MAGIC %md
# MAGIC # Build Dim Customer (SCD Type 2)
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `dim_customer`  
# MAGIC **Description**: Segment, tier, LTV changes  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("dim_customer")

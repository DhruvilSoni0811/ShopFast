...
# MAGIC %md
# MAGIC # Update Business KPIs
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `gold_business_metrics`  
# MAGIC **Description**: Cancellation rate, sync latency, recovered revenue  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("gold_business_metrics")

...
# MAGIC %md
# MAGIC # Build Fact Inventory Snapshot
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `fact_inventory_snapshot`  
# MAGIC **Description**: Point-in-time ATP, value, coverage  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("fact_inventory_snapshot")

...
# MAGIC %md
# MAGIC # Build Dim Location
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `dim_location`  
# MAGIC **Description**: Warehouses, stores, online  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("dim_location")

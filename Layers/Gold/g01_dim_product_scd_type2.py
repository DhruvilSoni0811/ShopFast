...
# MAGIC %md
# MAGIC # Build Dim Product (SCD Type 2)
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `dim_product`  
# MAGIC **Description**: Track name, category, supplier changes  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("dim_product")

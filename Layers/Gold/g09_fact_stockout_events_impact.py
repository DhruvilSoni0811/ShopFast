...
# MAGIC %md
# MAGIC # Build Fact Stockout Events
# MAGIC
# MAGIC **Layer**: Gold  
# MAGIC **Target table(s)**: `fact_stockout_events`  
# MAGIC **Description**: Revenue loss, root cause, resolution  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("fact_stockout_events")

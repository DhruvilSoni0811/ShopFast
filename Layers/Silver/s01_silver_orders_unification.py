...
# MAGIC %md
# MAGIC # Unify Orders (Web + Mobile)
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_orders`  
# MAGIC **Description**: Harmonise schema, dedupe, SCD prep  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_orders")

...
# MAGIC %md
# MAGIC # Run Data-Quality Suite
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_data_quality_checks`  
# MAGIC **Description**: Great Expectations + custom rules  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_data_quality_checks")

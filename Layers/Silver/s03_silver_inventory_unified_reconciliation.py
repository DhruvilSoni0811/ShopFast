...
# MAGIC %md
# MAGIC # Reconcile Inventory Across Sources
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_inventory_unified`  
# MAGIC **Description**: Merge 5 sources, calculate ATP  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_inventory_unified")

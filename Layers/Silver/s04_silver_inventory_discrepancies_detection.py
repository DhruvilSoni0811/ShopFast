...
# MAGIC %md
# MAGIC # Detect Inventory Discrepancies
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_inventory_discrepancies`  
# MAGIC **Description**: Negative qty, reserved > physical, etc.  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_inventory_discrepancies")

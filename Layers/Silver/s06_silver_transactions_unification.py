...
# MAGIC %md
# MAGIC # Unify Transactions (All Channels)
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_transactions`  
# MAGIC **Description**: Web, app, POS sales in one table  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_transactions")

...
# MAGIC %md
# MAGIC # Harmonise Product Master
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_products`  
# MAGIC **Description**: SCD Type-2 prep, supplier mapping  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_products")

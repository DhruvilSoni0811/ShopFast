...
# MAGIC %md
# MAGIC # Unify Transaction Line Items
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_transaction_items`  
# MAGIC **Description**: With inventory impact  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_transaction_items")

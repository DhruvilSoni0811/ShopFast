...
# MAGIC %md
# MAGIC # Consolidate Inventory Movements
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_inventory_movements`  
# MAGIC **Description**: Sales, returns, transfers, adjustments  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_inventory_movements")

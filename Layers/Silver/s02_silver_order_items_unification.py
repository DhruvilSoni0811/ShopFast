...
# MAGIC %md
# MAGIC # Unify Order Items
# MAGIC
# MAGIC **Layer**: Silver  
# MAGIC **Target table(s)**: `silver_order_items`  
# MAGIC **Description**: Standard fields across channels  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("silver_order_items")

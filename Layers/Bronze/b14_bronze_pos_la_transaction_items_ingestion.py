...
# MAGIC %md
# MAGIC # Ingest LA Transaction Items
# MAGIC
# MAGIC **Layer**: Bronze  
# MAGIC **Target table(s)**: `bronze_pos_la_transaction_items`  
# MAGIC **Description**: Line items with inventory impact  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("bronze_pos_la_transaction_items")

...
# MAGIC %md
# MAGIC # Ingest LA Inventory Adjustments
# MAGIC
# MAGIC **Layer**: Bronze  
# MAGIC **Target table(s)**: `bronze_pos_la_inventory_adjustments`  
# MAGIC **Description**: Damage/theft/return events  
...
# Example:
# df.write #   .format("delta") #   .mode("append") #   .option("mergeSchema", "true") #   .saveAsTable("bronze_pos_la_inventory_adjustments")
